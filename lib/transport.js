...
(function() {
  var Dispatch, Lock, RobustTransport, StreamWrapper, Timer, Transport, dbg, iced, log, net, path, process, tls, __iced_k, __iced_k_noop,
  ...
  exports.Transport = Transport = (function(_super) {
    ...
    Transport.prototype._connect_critical_section = function(cb) {
      var CLS, CON, ERR, TMO, connect_event_name, err, name, ok, oldCwd, opts, rv, rv_id, val, x, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref, _ref1, _ref2;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
