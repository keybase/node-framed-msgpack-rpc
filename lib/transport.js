...
(function() {
  var Dispatch, Lock, RobustTransport, StreamWrapper, Timer, Transport, dbg, iced, log, net, tls, __iced_k, __iced_k_noop,
  ...
  exports.Transport = Transport = (function(_super) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/mike/node-framed-msgpack-rpc/src/transport.iced",
    ...
    Transport.prototype._connect_critical_section = function(cb) {
      var CLS, CON, ERR, TMO, connect_event_name, err, name, ok, oldCwd, opts, path, process, rv, rv_id, val, x, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref, _ref1, _ref2;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      if (this.tls_opts != null) {
        ...
        if ((this.net_opts.path != null) && this.net_opts.path.length >= 103) {
          ...
          oldCwd = process.cwd();
          process.chdir(path.dirname(this.net_opts.path));
          this.net_opts.path = path.basename(this.net_opts.path);
        }
