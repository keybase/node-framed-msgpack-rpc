  ...
  exports.Transport = Transport = (function(_super) {
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/chrisnojima/go/src/github.com/keybase/node-framed-msgpack-rpc/src/transport.iced",
    ...
    Transport.prototype._activate_stream = function(x) {
      ...
      return x.on('data', (function(_this) {
        return function(msg) {
          return _this.packetize_data(new Uint8Array(msg.buffer, msg.byteOffset, msg.byteLength));
        };
      })(this));
    };
