...
(function() {
  var Dispatch, Lock, RobustTransport, StreamWrapper, Timer, Transport, dbg, iced, log, net, pp, process, tls, __iced_k, __iced_k_noop,
  ...
  exports.Transport = Transport = (function(_super) {
    ...
    function Transport(_arg) {
      ...
      this.port = _arg.port, this.host = _arg.host, this.net_opts = _arg.net_opts, net_stream = _arg.net_stream, this.log_obj = _arg.log_obj, this.parent = _arg.parent, this.do_tcp_delay = _arg.do_tcp_delay, this.hooks = _arg.hooks, dbgr = _arg.dbgr, this.path = _arg.path, this.tls_opts = _arg.tls_opts, connect_timeout = _arg.connect_timeout;
      ...
      (function(_this) {
        return (function(__iced_k) {
          __iced_deferrals = new iced.Deferrals(__iced_k, {
            ...
            filename: "/Users/joshblum/SourceCode/src/github.com/keybase/node-framed-msgpack-rpc/src/transport.iced",
    ...
    Transport.prototype._connect_critical_section = function(cb) {
      var CLS, CON, ERR, TMO, connect_event_name, err, ex, name, ok, oldCwd, opts, path_info, rv, rv_id, val, x, ___iced_passed_deferral, __iced_deferrals, __iced_k, _ref, _ref1, _ref2;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      if (this.tls_opts != null) {
        ...
        if ((this.net_opts.path != null) && this.net_opts.path.length >= 103) {
          oldCwd = process.cwd();
          path_info = pp(this.net_opts.path);
          try {
      ...
      _ref2 = [0, 1, 2, 3], CON = _ref2[0], ERR = _ref2[1], CLS = _ref2[2], TMO = _ref2[3];
        ...
        return function() {
          if (oldCwd != null) {
            try {
              ...
              ex = _error;
              _this._warn("could not recover cwd: " + ex.code + " " + ex.message);
          ...
          (function(__iced_k) {
            if (ok) {
              ...
              (function(__iced_k) {
                var _ref3;
                if (((_ref3 = _this.hooks) != null ? _ref3.after_connect : void 0) != null) {
                  (function(__iced_k) {
                    __iced_deferrals = new iced.Deferrals(__iced_k, {
                      parent: ___iced_passed_deferral,
                      filename: "/Users/joshblum/SourceCode/src/github.com/keybase/node-framed-msgpack-rpc/src/transport.iced",
              ...
              return __iced_k(err == null ? err = new Error("error in connection") : void 0);
            }
          })(function() {
            return cb(err);
          });
  ...
  exports.RobustTransport = RobustTransport = (function(_super) {
    ...
    function RobustTransport(sd, d) {
      ...
      this.queue_max = d.queue_max, this.warn_threshold = d.warn_threshold, this.error_threshold = d.error_threshold;
      this.reconnect_delay = (x = d.reconnect_delay) ? x : 1;
      if (this.queue_max == null) {
        this.queue_max = 1000;
      }
      this._time_rpcs = (this.warn_threshold != null) || (this.error_threshold != null);
      this._waiters = [];
    }
    ...
    RobustTransport.prototype._connect_critical_section = function(cb) {
      var err, ___iced_passed_deferral, __iced_deferrals, __iced_k;
      __iced_k = __iced_k_noop;
      ___iced_passed_deferral = iced.findDeferral(arguments);
      (function(_this) {
    ...
    RobustTransport.prototype._timed_invoke = function(arg, cb) {
      ...
      et = this.error_threshold ? this.error_threshold * 1000 : 0;
      wt = this.warn_threshold ? this.warn_threshold * 1000 : 0;
      if (et) {
