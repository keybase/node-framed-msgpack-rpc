...
(function() {
  ...
  exports.Packetizer = Packetizer = (function() {
    ...
    Packetizer.prototype._get_frame = function() {
      ...
      _ref1 = unpack(f_full, frame_len), w = _ref1[0], r = _ref1[1];
      if (w != null) {
