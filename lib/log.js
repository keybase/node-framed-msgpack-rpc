...
(function() {
  var L, Logger, default_level, default_logger_class, isError, stringify, util;

  util = require('util');

  isError = function(o) {
    if (typeof Error.isError === 'function' && Error.isError(o)) {
      return true;
    } else if (typeof util.isError === 'function' && util.isError(o)) {
      return true;
    } else {
