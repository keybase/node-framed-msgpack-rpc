...
(function() {
  ...
  exports.Response = Response = (function() {
    function Response(dispatch, seqid) {
  ...
  exports.Dispatch = Dispatch = (function(_super) {
    ...
    Dispatch.prototype._serve = function(_arg) {
      var cancelled, debug_msg, err, hw, method, pair, param, response;
      method = _arg.method, param = _arg.param, response = _arg.response, cancelled = _arg.cancelled;
