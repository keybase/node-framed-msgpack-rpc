...
(function() {
  var Dispatch, E, Packetizer, Response, dbg, iced, __iced_k, __iced_k_noop,
  ...
  exports.Response = Response = (function() {
    function Response(dispatch, seqid, cancelled) {
    ...
    Response.prototype.result = function(res) {
      if (this.cancelled) {
        this.dispatch._warn("Called result on cancelled response: " + this.seqid);
        return;
      }
      if (this.debug_msg) {
    ...
    Response.prototype.error = function(err) {
      if (this.cancelled) {
        this.dispatch._warn("Called error on cancelled response: " + this.seqid);
        return;
      }
      if (this.debug_msg) {
      ...
      if (!msg instanceof Array || msg.length < 2) {
        ...
        switch ((type = msg.shift())) {
          ...
          case this.CANCEL:
            ...
            response = new Response(this, seqid, type === this.CANCEL);
            return this._serve({
              method: method,
              param: param,
              response: response
          ...
          if ((cb != null) || !notify) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/Users/chrisnojima/code/node-framed-msgpack-rpc/src/dispatch.iced",
