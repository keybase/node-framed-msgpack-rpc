...
(function() {
  var COMPRESSION_TYPE_GZIP, COMPRESSION_TYPE_NONE, Dispatch, E, Packetizer, Response, compress, dbg, iced, pack, pako, toBuffer, uncompress, unpack, __iced_k, __iced_k_noop, _ref,
  ...
  uncompress = function(ctype, data) {
    ...
    switch (ctype) {
      ...
      case COMPRESSION_TYPE_GZIP:
        ...
        _ref1 = unpack(toBuffer(data)), err = _ref1[0], data = _ref1[1];
        if (err == null) {
          return data;
        }
        throw err;
          ...
          if ((cb != null) || !notify) {
            ...
            (function(__iced_k) {
              __iced_deferrals = new iced.Deferrals(__iced_k, {
                ...
                filename: "/Users/joshblum/SourceCode/src/github.com/keybase/node-framed-msgpack-rpc/src/dispatch.iced",
